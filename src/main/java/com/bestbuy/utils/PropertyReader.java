...
public class PropertyReader {
    ...
    public String getProperty(String propertyName){
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir")+"/C:\\Users\\ahirg\\IdeaProjects\\bestbuy-restassured-project1-serenity-krupali-lalkia\\src\\test\\resources\\propertyfile\\application.properties");
